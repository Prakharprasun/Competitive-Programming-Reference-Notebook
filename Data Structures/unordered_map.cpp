...
int main() {
    // all map func are valid for unordered_map but it aint sorted
    // unordered_map does most stuff o(n)
    // less key datatypes supported as compared to map cuz hashing all things are not easy
